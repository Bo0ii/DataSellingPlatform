...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'A-CompleteProfile-1',
          path: '/aCompleteProfile1',
          builder: (context, params) => ACompleteProfile1Widget(),
        ),
        FFRoute(
          name: 'forgotPassword',
          path: '/forgotPassword',
        ...
        FFRoute(
          name: 'A-AddDevice-2',
          path: '/aAddDevice2',
          builder: (context, params) => AAddDevice2Widget(),
        ),
        FFRoute(
          name: 'A-AddingDeviceFirst-3',
          path: '/aAddingDeviceFirst3',
