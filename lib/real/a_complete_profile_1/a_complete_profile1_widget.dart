...
import 'a_complete_profile1_model.dart';
export 'a_complete_profile1_model.dart';

class ACompleteProfile1Widget extends StatefulWidget {
  const ACompleteProfile1Widget({super.key});

  @override
  State<ACompleteProfile1Widget> createState() =>
      _ACompleteProfile1WidgetState();
}

class _ACompleteProfile1WidgetState extends State<ACompleteProfile1Widget>
    with TickerProviderStateMixin {
  late ACompleteProfile1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ACompleteProfile1Model());
