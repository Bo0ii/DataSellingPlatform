...
import 'a_adding_device_first3_model.dart';
export 'a_adding_device_first3_model.dart';

class AAddingDeviceFirst3Widget extends StatefulWidget {
  const AAddingDeviceFirst3Widget({super.key});

  @override
  State<AAddingDeviceFirst3Widget> createState() =>
      _AAddingDeviceFirst3WidgetState();
}

class _AAddingDeviceFirst3WidgetState extends State<AAddingDeviceFirst3Widget>
    with TickerProviderStateMixin {
  late AAddingDeviceFirst3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AAddingDeviceFirst3Model());
