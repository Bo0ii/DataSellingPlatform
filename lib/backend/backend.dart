...
import 'schema/data_selling_platform_record.dart';
...
export 'schema/data_selling_platform_record.dart';
...
/// Functions to query DataSellingPlatformRecords (as a Stream and as a Future).
Future<int> queryDataSellingPlatformRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DataSellingPlatformRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DataSellingPlatformRecord>> queryDataSellingPlatformRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DataSellingPlatformRecord.collection,
      DataSellingPlatformRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DataSellingPlatformRecord>> queryDataSellingPlatformRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
